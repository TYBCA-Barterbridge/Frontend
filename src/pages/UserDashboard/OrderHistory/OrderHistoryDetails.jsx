...
import { BiLeftArrow, BiStar, BiArrowToRight } from "react-icons/bi";
    ...
    <div className="max-w-3xl mx-auto p-4">
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center">
          ...
          <Link
            ...
            className="text-2xl font-bold mb-4 text-gray-800 hover:underline"
          >
            ORDER DETAILS
          </Link>
        </div>
      ...
      <div className="bg-amber-50 rounded-lg p-4 mb-6">
        ...
        <p className="text-gray-600">
          Order Type: Exchange • Order Placed on March 20, 2025 07:52
        </p>
      </div>
      ...
      <div className="mb-10">
        <div className="relative flex items-center justify-between mb-6">
          {/* Background line */}
          <div className="absolute left-0 right-0 top-1/3 h-1 text-orange-400 bg-gray-600 -z-10"></div>

          {/* Dynamic progress bar */}
          <div
            className="absolute left-0 top-1/2 h-1 bg-orange-400 -z-5 transition-all"
            style={{
        ...
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <div className="flex items-center mb-4">
              ...
              />
              <div>
                <p className="font-medium">Bhavesh Kapshikar</p>
                <p className="text-sm text-gray-600">Dona-Paul, Goa</p>
              </div>
            </div>

            <div className="space-y-2 text-sm">
              <p>
                <span className="text-gray-600">Email:</span> bhaveshkapshikar@gmail.com
              </p>
              <p>
                <span className="text-gray-600">Sec Email:</span> bvk@gmail.com
              </p>
              <p>
          ...
          <div className="md:w-1/2">
            <div className="flex justify-between items-center mb-4">
              ...
              <a href="#" className="text-blue-500 flex items-center text-sm">
                View reviews <BiArrowToRight className="h-4 w-4 ml-1" />
              </a>
            </div>
              ...
              {[5, 4, 3, 2, 1].map((rating) => (
                <div key={rating} className="flex items-center">
                  <div className="w-8 flex items-center">
                    <span>{rating}</span>
                    <BiStar className="h-4 w-4 ml-1 text-yellow-500 fill-yellow-500" />
                  </div>
            ...
            >
              Leave a rating <BiArrowToRight className="h-4 w-4 ml-1" />
            </a>
          </div>
        </div>
      </div>
