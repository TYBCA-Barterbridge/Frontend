...
import { useGetWorkshopByIdQuery, useEditParticipantStatusMutation } from '../../../features/workshop/workshopApiSlice';
...
const WorkshopParticipants = ({ closeModal, workshopId }) => {
  const { data: workshop, isLoading: isWorkshopLoading } = useGetWorkshopByIdQuery(workshopId);
  const [editParticipantStatus, { isLoading: isStatusUpdating }] = useEditParticipantStatusMutation();
      ...
      <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-2">{workshop.workshop_name}</h2>
              <p className="text-gray-600">
                <FaCalendar className="inline mr-2" />
                {format(new Date(workshop.workshop_date), 'MMMM dd, yyyy')}
              </p>
            </div>
