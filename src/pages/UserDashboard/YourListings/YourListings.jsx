...
const YourListings = () => {
  ...
  return (
    <>
      ...
      <div className="container bg-gray-100 rounded-lg mx-auto px-4 py-6">
        {/* Header Section */}
        ...
        {/* Listings Section */}
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-3 gap-10 bg-white p-6">
          {/* Add Product/Skill Button */}
          <div
            className="flex flex-col items-center justify-center w-[280px] h-[350px] border-2 border-dashed border-gray-300 rounded-lg text-[#f48024] font-bold cursor-pointer hover:bg-gray-200"
            onClick={openModal}
          >
