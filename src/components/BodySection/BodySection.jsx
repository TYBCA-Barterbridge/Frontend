...
const BodySection = () => {
  return (
    <motion.div
      className="max-w-[1350px] mx-auto flex flex-col lg:flex-row justify-between rounded-xl p-5 bg-gray-100 gap-8 mb-5"
    >
      <div className="lg:flex-2 bg-blue-50 p-5 rounded-lg flex flex-col items-start shadow-md relative w-full">
        ...
        <a href="./ProductDetails">
          <motion.img
            ...
            alt="Guitar"
            className="absolute right-0 top-5 w-[400px] h-[220px] cursor-pointer mr-5 rounded-md object-cover hidden lg:block"
          />
        </a>
      </div>

      <div className="lg:flex-1 flex flex-col gap-2 w-full">
